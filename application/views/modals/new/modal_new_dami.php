<!-- Modal -->
<div class="modal fade" id="damiModal" tabindex="-1" role="dialog" aria-labelledby="damiModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="damiModalLabel">Crear Dami</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?php echo form_open('Callcenter/AddDami','id="form-new-dami"') ?>
                        ...
                        <div class=" col-4 from-group">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-prepend">
                                    <button class="input-group-text" id="ValidateClient" onclick="ValidarDatosExistentes();" style="padding: 0 .4rem 0 .4rem;"><i id="ValidateData" class="fa fa-search"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class=" col-4 from-group">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="damiModalLabel">Producto</h5>
            </div>
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        <div class=" col-4 from-group">
                            <label for="clLvlform">Producto</label>
                            <select class="custom-select custom-select-sm" name="dmProd" id="dmProd" required>
                                <option value="">Seleccione</option>
