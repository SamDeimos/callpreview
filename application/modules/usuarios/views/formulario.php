        ...
        <div class="row">
            ...
            <div class="col-6 border-right">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-sm" name="nombre" id="nombre" type="text" value="<?php echo set_value("nombre", (isset($cliente->nombres) ? $cliente->nombres : "")); ?>">
                </div>
                <div class="form-group">
                    <label for="nombre">Contraseña</label>
                    <input class="form-control form-control-sm" name="pass" id="pass" type="password" value="<?php echo set_value("pass", (isset($cliente->nombres) ? $cliente->nombres : "")); ?>">
                </div>
                <div class="form-group">
                    <label for="email">Correo electrónico</label>
                    <input class="form-control form-control-sm" name="email" id="email" type="text" value="<?php echo set_value("email", (isset($cliente->email) ? $cliente->email : "")); ?>">
                </div>
                <div class="row">
                    <!-- Columna izquierda -->
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select custom-select-sm" name="permiso" id="permiso" >
                                ...
                                <option <?php echo ((isset($cliente->id_lvlformacion) ? $cliente->id_lvlformacion : "") == $lvlformacion->id_lvlformacion) ? "selected" : ""; ?> value="<?php echo $permiso->id_permiso; ?>"><?php echo $permiso->perfil; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <?php foreach($estadousers as $estadouser){ ?>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" <?php echo ((isset($cliente->id_genero) ? $cliente->id_genero : "1") == $genero->id_genero) ? "checked" : ""; ?> id="estadosistem<?php echo $estadouser->id_statususer; ?>" name="estadosistem[]" class="custom-control-input" value="<?php echo $estadouser->id_statususer; ?>">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input class="form-control form-control-sm" name="cedula" id="cedula" type="text" value="<?php echo set_value("cedula", (isset($cliente->dni) ? $cliente->dni : "")); ?>">
                </div>
                <div class="row form-group">
                    <!-- Columna izquierda -->
                    <div class="col-6">
                        <label for="tel">Teléfono</label>
                        <input class="form-control form-control-sm" name="tel" id="tel" type="text" value="<?php echo set_value("tel", (isset($cliente->tel) ? $cliente->tel : "")); ?>">
                    </div>
                    <!-- Columna derecha -->
                    <div class="col-6">
                        <label for="fec_nac">Fecha de nacimineto</label>
                        <input class="form-control form-control-sm" name="fec_nac" id="fec_nac" type="text" value="<?php echo set_value("fec_nac", (isset($cliente->fec_nac) ? $cliente->fec_nac : "")); ?>">
                    </div>
                </div>
                <div class="form-group">
