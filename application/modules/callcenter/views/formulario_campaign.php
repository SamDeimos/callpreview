<div class="card mt-4">
    <div class="card-acction">
        <div class="row">
            <div class="col-6">
                <h4 class="text-muted">Crea campaña</h4>
            </div>
            <div class="col-6">
...
<?php if (!$scripts || !$forms || !$vendedores) : ?>
    <div class="card mt-4">
        <div class="card-body">
            <p><strong>ALERTA:</strong> Para crear campañas asegurese de haber creado previamente, <a target="_blank" href="<?php echo base_url(); ?>sistema/usuarios">Vendedores</a>, <a target="_blank" href="<?php echo base_url(); ?>callcenter/forms">Formularios</a> y <a target="_blank" href="<?php echo base_url(); ?>callcenter/scripts">Guiones</a></p>
        </div>
    </div>
<?php else : ?>
    <div class="card mt-4">
